...
(create-workbook "chart-scatter-example.xlsx")
(add-worksheet "")
...
(create-chart ($chart-type 'scatter))
...
(set-pos 0 0)
(write-worksheet-data)
(create-chart ($chart-type 'scatter-straight-with-markers))
...
(set-pos 0 0)
(write-worksheet-data)
(create-chart ($chart-type 'scatter-straight))
...
(set-pos 0 0)
(write-worksheet-data)
(create-chart ($chart-type 'scatter-smooth-with-markers))
(create-chart-series "=Sheet4!$A$2:$A$7" "=Sheet4!$B$2:$B$7")
(chart-series-set-name "=Sheet1!$B$1")
(create-chart-series "=Sheet4!$A$2:$A$7" "=Sheet4!$C$2:$C$7")
(chart-series-set-name "=Sheet4!$C$1")
(chart-title-set-name "Results of sample analysis")
(chart-x-axis-set-name "Test number")
(chart-y-axis-set-name "Sample length (mm)")
(chart-set-style 11)
...
(set-pos 0 0)
(write-worksheet-data)
(create-chart ($chart-type 'scatter-smooth))
(create-chart-series "=Sheet5!$A$2:$A$7" "=Sheet5!$B$2:$B$7")
(chart-series-set-name "=Sheet1!$B$1")
(create-chart-series "=Sheet5!$A$2:$A$7" "=Sheet5!$C$2:$C$7")
(chart-series-set-name "=Sheet5!$C$1")
(chart-title-set-name "Results of sample analysis")
(chart-x-axis-set-name "Test number")
(chart-y-axis-set-name "Sample length (mm)")
(chart-set-style 11)
